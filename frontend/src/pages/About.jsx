  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F4EFE6" }}>
      <div className="relative h-[60vh] min-h-[400px] overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1800&h=900&fit=crop&auto=format" 
          alt="Baba Au Rhum exterior" 
          className="w-full h-full object-cover" 
        />
        <div className="absolute inset-0 bg-black/20" />
        <div className="absolute bottom-12 left-6 lg:left-16" style={{ textAlign: "left" }}>
          <span 
            className="uppercase font-sans font-medium tracking-[4px]" 
            style={{ 
              fontSize: "12px", 
              color: "#FFFFFF",
              opacity: "0.8",
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-7" style={{ textAlign: "left" }}>
            <p className="font-serif text-2xl font-medium leading-relaxed mb-6 italic" style={{ color: "#2C1A0E" }}>
              "We didn't plan a restaurant. We planted a garden and the kitchen followed."
            </p>
            <p className="font-sans leading-relaxed mb-5" style={{ color: "#6b6375" }}>
            ...
            <p className="font-sans leading-relaxed mb-10" style={{ color: "#6b6375" }}>
        ...
        <div className="mt-20 pt-16" style={{ borderTop: "1px solid #E8E0D4", textAlign: "left" }}>
          <span 
          ...
          <h2 className="font-serif text-3xl font-semibold mb-12" style={{ color: "#2C1A0E" }}>The things we don't compromise on.</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <p className="font-serif text-5xl font-light mb-4" style={{ color: "rgba(192, 92, 56, 0.3)" }}>{v.n}</p>
                <h3 className="font-serif text-xl font-semibold mb-3" style={{ color: "#2C1A0E" }}>{v.t}</h3>
                <p className="font-sans text-sm leading-relaxed" style={{ color: "#6b6375" }}>{v.d}</p>
              </div>
            ))}
          </div>
        </div>
